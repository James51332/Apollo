...
#define GL_FUNCS                                                                                                  \
  ...
  GL_FUNC(GLvoid, glUniform1f, GLint location, GLfloat)                                                           \
  GL_FUNC(GLvoid, glUniform2f, GLint location, GLfloat, GLfloat)                                                  \
  GL_FUNC(GLvoid, glUniform3f, GLint location, GLfloat, GLfloat, GLfloat)                                         \
  GL_FUNC(GLvoid, glUniform4f, GLint location, GLfloat, GLfloat, GLfloat, GLfloat)                                \
  GL_FUNC(GLvoid, glUniformMatrix3fv, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)   \
